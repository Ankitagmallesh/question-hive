        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
            ...
            <div className="shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] bg-white border border-slate-200 p-8 rounded-[2.5rem] flex flex-col h-full">
                ...
                <div className="space-y-6 flex-1">
                    <div>
                        ...
                        <AnimatedBar width="85%" colorClass="bg-indigo-600" />
                    </div>
                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                         ...
                         <AnimatedBar width="65%" colorClass="bg-indigo-400" />
                    </div>
                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2 text-slate-400">
                         ...
                         <AnimatedBar width="35%" colorClass="bg-slate-300" />
                    </div>
                </div>
            </div>
            ...
            <div className="lg:col-span-2 shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] bg-white border border-slate-200 p-8 rounded-[2.5rem]">
                ...
                <div className="h-56 w-full flex items-end justify-between gap-3 px-2">
                    <div className="w-full flex flex-col justify-end h-full group relative">
                         <AnimatedHeightBar height="20%" colorClass="bg-indigo-50 group-hover:bg-indigo-600 transition-colors duration-300" delay={0.1} />
                    </div>
                     <div className="w-full flex flex-col justify-end h-full group relative">
                         <AnimatedHeightBar height="35%" colorClass="bg-indigo-100 group-hover:bg-indigo-600 transition-colors duration-300" delay={0.2} />
                    </div>
                    <div className="w-full flex flex-col justify-end h-full group relative">
                         <AnimatedHeightBar height="45%" colorClass="bg-indigo-200 group-hover:bg-indigo-600 transition-colors duration-300" delay={0.3} />
                    </div>
                    <div className="w-full flex flex-col justify-end h-full group relative">
                         <AnimatedHeightBar height="65%" colorClass="bg-indigo-300 group-hover:bg-indigo-600 transition-colors duration-300" delay={0.4} />
                    </div>
                    <div className="w-full flex flex-col justify-end h-full group relative">
                         <AnimatedHeightBar height="85%" colorClass="bg-indigo-400 group-hover:bg-indigo-600 transition-colors duration-300" delay={0.5} />
                    </div>
                    <div className="w-full flex flex-col justify-end h-full group relative">
                        <motion.div 
                            initial={{ height: 0 }}
                            ...
                            className="w-full rounded-t-2xl bg-indigo-600 shadow-lg shadow-indigo-100 relative"
                        >
                             <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-slate-800 text-white text-[10px] p-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10 pointer-events-none">Current: 12 Exports</div>
                        </motion.div>
                    </div>
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
            ...
            <div className="shadow-[0_4px_20px_-2px_rgba(0,0,0,0.05)] bg-white border border-slate-200 p-8 rounded-[2.5rem]">
                ...
                <div className="space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                            <span className="text-amber-600 bg-amber-50 px-2 py-0.5 rounded">Medium</span>
                    ...
                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                            <span className="text-rose-600 bg-rose-50 px-2 py-0.5 rounded">Hard</span>
                 ...
                 <div className="space-y-5">
                    <div>
                        ...
                        <div className="w-full h-4 rounded-lg overflow-hidden flex">
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "30%" }} transition={{ duration: 1 }} className="bg-emerald-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "50%" }} transition={{ duration: 1, delay: 0.2 }} className="bg-amber-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "20%" }} transition={{ duration: 1, delay: 0.4 }} className="bg-rose-500 h-full" />
                        </div>
                    </div>

                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                            <span className="text-slate-700">Math_JEE_Mock_01</span>
                            <span className="text-slate-400 text-[10px]">Challenging</span>
                        </div>
                        <div className="w-full h-4 rounded-lg overflow-hidden flex">
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "15%" }} transition={{ duration: 1 }} className="bg-emerald-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "45%" }} transition={{ duration: 1, delay: 0.2 }} className="bg-amber-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "40%" }} transition={{ duration: 1, delay: 0.4 }} className="bg-rose-500 h-full" />
                        </div>
                    </div>

                    <div>
                        <div className="flex justify-between text-xs font-bold mb-2">
                            <span className="text-slate-700">Chem_Beginner_Test</span>
                            <span className="text-slate-400 text-[10px]">Introductory</span>
                        </div>
                        <div className="w-full h-4 rounded-lg overflow-hidden flex">
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "60%" }} transition={{ duration: 1 }} className="bg-emerald-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "30%" }} transition={{ duration: 1, delay: 0.2 }} className="bg-amber-400 h-full" />
                            <motion.div initial={{ width: 0 }} whileInView={{ width: "10%" }} transition={{ duration: 1, delay: 0.4 }} className="bg-rose-500 h-full" />
                        </div>
                    </div>
                 </div>

                 <div className="flex justify-center gap-4 mt-6">
                     <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-emerald-400"></div><span className="text-[10px] font-bold text-slate-400 uppercase">Easy</span></div>
                     <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-amber-400"></div><span className="text-[10px] font-bold text-slate-400 uppercase">Med</span></div>
                     <div className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-rose-500"></div><span className="text-[10px] font-bold text-slate-400 uppercase">Hard</span></div>
                 </div>
            </div>
        </div>
            ...
            <div className="space-y-4">
                <div className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-100 hover:border-indigo-200 transition-all cursor-pointer group">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            ...
                            <p className="text-[10px] text-slate-400 font-semibold italic">Exported 14 mins ago • NEET Format • 45 Questions</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <span className="text-[9px] font-black bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full uppercase">Success</span>
                ...
                <div className="flex items-center justify-between p-5 bg-slate-50 rounded-2xl border border-slate-100 hover:border-indigo-200 transition-all cursor-pointer group">
                    <div className="flex items-center gap-5">
                        <div className="w-12 h-12 bg-white rounded-xl shadow-sm flex items-center justify-center text-xl group-hover:scale-110 transition-transform">📄</div>
                        <div>
                            <p className="text-sm font-bold text-slate-900 uppercase tracking-tight">Math_JEE_Main_Mock_01.pdf</p>
                            <p className="text-[10px] text-slate-400 font-semibold italic">Exported 2 hours ago • JEE Format • 30 Questions</p>
                        </div>
                    </div>
                    <div className="flex items-center gap-3">
                        <span className="text-[9px] font-black bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full uppercase">Success</span>
